...
# -*- coding: utf-8 -*-
#
# jupyterview documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jupyterview', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterviewdoc'
...
latex_documents = [
    (master_doc, 'jupyterview.tex', 'jupyterview Documentation',
     'Trung Le', 'manual'),
]
