...
/* harmony import */ var _kernel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./kernel */ "./lib/kernel.js");
...
/* harmony import */ var _mainview_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mainview/model */ "./lib/mainview/model.js");
/* harmony import */ var _mainview_widget__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mainview/widget */ "./lib/mainview/widget.js");
...
/* harmony import */ var _reader_manager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./reader/manager */ "./lib/reader/manager.js");
/* harmony import */ var _reader_meshioParser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./reader/meshioParser */ "./lib/reader/meshioParser.js");
/* harmony import */ var _reader_vtkParser__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./reader/vtkParser */ "./lib/reader/vtkParser.js");
/* harmony import */ var _token__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./token */ "./lib/token.js");
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./tools */ "./lib/tools.js");
/* harmony import */ var _vtkTracker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./vtkTracker */ "./lib/vtkTracker.js");
...
const activate = (app, restorer, themeManager, shell) => {
    const tracker = new _vtkTracker__WEBPACK_IMPORTED_MODULE_12__.VtkTracker({ namespace: NAME_SPACE });
    _mainview_model__WEBPACK_IMPORTED_MODULE_4__.JupyterViewModel.kernel = new _kernel__WEBPACK_IMPORTED_MODULE_2__.KernelExecutor({
    ...
    const parserManager = new _reader_manager__WEBPACK_IMPORTED_MODULE_7__.ParserManager();
    const vtkParser = new _reader_vtkParser__WEBPACK_IMPORTED_MODULE_9__.VtkParser();
    parserManager.registerParser(vtkParser);
    const meshioParser = new _reader_meshioParser__WEBPACK_IMPORTED_MODULE_8__.MeshIOParser();
    ...
    shell.currentChanged.connect((shell, change) => {
        ...
        if (widget instanceof _mainview_widget__WEBPACK_IMPORTED_MODULE_5__.JupyterViewWidget) {
...
const controlPanel = {
    ...
    activate: (app, restorer, shell, tracker) => {
        ...
        controlPanel.title.icon = _tools__WEBPACK_IMPORTED_MODULE_11__.jvcLightIcon;
        if (restorer) {
...
/* harmony import */ var _model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model */ "./lib/mainview/model.js");
/* harmony import */ var _widget__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./widget */ "./lib/mainview/widget.js");
...
class JupyterViewWidgetFactory extends _jupyterlab_docregistry__WEBPACK_IMPORTED_MODULE_0__.ABCWidgetFactory {
    ...
    createNewWidget(context) {
        return new _widget__WEBPACK_IMPORTED_MODULE_2__.JupyterViewWidget({
            context,
            content: new _widget__WEBPACK_IMPORTED_MODULE_2__.JupyterViewPanel(context, this.parsers)
        });
    }
}
/**
...
class JupyterViewModelFactory {
     ...
     */
    createNew(options) {
        const model = new _model__WEBPACK_IMPORTED_MODULE_1__.JupyterViewModel(options);
        return model;
    }
}
...
/* harmony import */ var _tools__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../tools */ "./lib/tools.js");
/* harmony import */ var _cameraToolbar__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./cameraToolbar */ "./lib/mainview/cameraToolbar.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./utils */ "./lib/mainview/utils.js");
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @jupyterlab/coreutils */ "webpack/sharing/consume/default/@jupyterlab/coreutils");
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_23___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_23__);
...
class MainView extends react__WEBPACK_IMPORTED_MODULE_2__.Component {
    constructor(props) {
        ...
        this.handleThemeChange = (newTheme) => {
            this.setState(old => ({ ...old, theme: newTheme }), () => {
                const style = this.state.theme === _utils__WEBPACK_IMPORTED_MODULE_22__.LIGHT_THEME
                ...
                this._actor.getProperty().setColor(..._utils__WEBPACK_IMPORTED_MODULE_22__.OBJECT_COLOR[this.state.theme]);
            });
        };
        ...
        this.createPipeline = (polyResult) => {
            ...
            const fontColor = this.state.theme === _utils__WEBPACK_IMPORTED_MODULE_22__.LIGHT_THEME
                ? 'rgba(0, 0, 0, 0.87)'
            ...
            this._scalarBarActor.setAxisTextStyle({
                fontColor,
                fontFamily: _utils__WEBPACK_IMPORTED_MODULE_22__.JUPYTER_FONT,
                fontSize: '18px'
            });
        ...
        this.rotate = (angle) => {
            ...
            _kitware_vtk_js_Common_Core_MatrixBuilder__WEBPACK_IMPORTED_MODULE_6__["default"]
                .buildFromDegree()
        ...
        this.rotateWithAnimation = (direction) => {
            ...
            return () => {
                ...
                const rotate = () => {
                    if (count < 90) {
                        count += _utils__WEBPACK_IMPORTED_MODULE_22__.ROTATION_STEP;
                        this.rotate(sign * _utils__WEBPACK_IMPORTED_MODULE_22__.ROTATION_STEP);
                    }
                    else {
        ...
        this.updateOrientation = (mode) => {
            if (!this._inAnimation) {
                ...
                const { axis, orientation, viewUp } = _tools__WEBPACK_IMPORTED_MODULE_20__.VIEW_ORIENTATIONS[mode];
                ...
                (0,_tools__WEBPACK_IMPORTED_MODULE_20__.moveCamera)(camera, this._renderer, interactor, destFocalPoint, destPosition, destViewUp, animateSteps).then(() => {
        ...
        this._syncCamera = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.debounce)(() => {
        ...
        const theme = (window.jupyterlabTheme ||
            _utils__WEBPACK_IMPORTED_MODULE_22__.LIGHT_THEME);
        this.state = {
    ...
    componentDidMount() {
        setTimeout(() => {
            ...
            vw.onOrientationChange(({ up, direction, action, event }) => {
                ...
                let axis = [];
                if (direction[0]) {
                    axis = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.majorAxis)(viewUp, 1, 2);
                }
                if (direction[1]) {
                    axis = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.majorAxis)(viewUp, 0, 2);
                }
                if (direction[2]) {
                    axis = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.majorAxis)(viewUp, 0, 1);
                }
            ...
            this._context.ready.then(() => {
                ...
                const fullPath = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.convertPath)(this._context.path);
                ...
                for (const [path, promise] of entries) {
                    ...
                    const fileNameOnly = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_23__.PathExt.basename(name);
    ...
    prepareFileContent(filePath, fileName, fileContent) {
        ...
        if (ext.toLowerCase() === 'pvd') {
            ...
            const xmlStr = (0,_tools__WEBPACK_IMPORTED_MODULE_20__.b64_to_utf8)(fileContent);
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_2__.createElement("div", { style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_2__.createElement("div", { ref: this.container, style: {
                    width: '100%',
                    height: 'calc(100%)',
                    background: _utils__WEBPACK_IMPORTED_MODULE_22__.BG_COLOR[this.state.theme] //'radial-gradient(#efeded, #8f9091)'
                } }),
            react__WEBPACK_IMPORTED_MODULE_2__.createElement(_cameraToolbar__WEBPACK_IMPORTED_MODULE_21__.CameraToolbar, { rotateHandler: this.rotateWithAnimation, resetCamera: this.resetCamera, updateOrientation: this.updateOrientation })));
    }
}
...
class JupyterViewModel {
    constructor(options) {
        ...
        this._cameraChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
...
class JupyterViewDoc extends _jupyter_ydoc__WEBPACK_IMPORTED_MODULE_1__.YDocument {
    constructor() {
        super();
        /**
         * Document version
        ...
        this._mainViewStateChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
        this._controlViewStateChanged = new _lumino_signaling__WEBPACK_IMPORTED_MODULE_0__.Signal(this);
...
/* harmony import */ var _mui_material_Accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mui/material/Accordion */ "./node_modules/@mui/material/Accordion/Accordion.js");
/* harmony import */ var _mui_material_AccordionDetails__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mui/material/AccordionDetails */ "./node_modules/@mui/material/AccordionDetails/AccordionDetails.js");
...
/* harmony import */ var _colorpanel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./colorpanel */ "./lib/panelview/colorpanel.js");
...
/* harmony import */ var _displaypanel__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./displaypanel */ "./lib/panelview/displaypanel.js");
...
const STOCK_STATE = {
    ...
    controlViewState: {
        ...
        displayMode: _displaypanel__WEBPACK_IMPORTED_MODULE_8__.DISPLAY_MODE[0].value,
        opacity: 1
    }
};
class MainView extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
    constructor(props) {
        ...
        this.updateSharedState = (0,_tools__WEBPACK_IMPORTED_MODULE_5__.debounce)((payload) => {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "jpview-control-panel" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], { expanded: this.state.datasetPanel, sx: { margin: '0px 0px' } },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionSummary__WEBPACK_IMPORTED_MODULE_4__["default"], { expandIcon: react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ExpandMore__WEBPACK_IMPORTED_MODULE_1__["default"], null), "aria-controls": "dataSetPanela-content", id: "displayPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('datasetPanel') },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null, "Dataset")),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionDetails__WEBPACK_IMPORTED_MODULE_3__["default"], { sx: panelBodyStyle },
            ...
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], { expanded: this.state.displayPanel },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionSummary__WEBPACK_IMPORTED_MODULE_4__["default"], { expandIcon: react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ExpandMore__WEBPACK_IMPORTED_MODULE_1__["default"], null), "aria-controls": "displayPanela-content", id: "displayPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('displayPanel') },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null, "Display")),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionDetails__WEBPACK_IMPORTED_MODULE_3__["default"], { sx: panelBodyStyle },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_displaypanel__WEBPACK_IMPORTED_MODULE_8__["default"], { clientId: "", onOpacityChange: this.onOpacityChange, onDisplayModeChange: this.onDisplayModeChange, controlViewState: this.state.controlViewState }))),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], { expanded: this.state.colorPanel },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionSummary__WEBPACK_IMPORTED_MODULE_4__["default"], { expandIcon: react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ExpandMore__WEBPACK_IMPORTED_MODULE_1__["default"], null), "aria-controls": "colorPanela-content", id: "colorPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('colorPanel') },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "lm-Widget" }, "Color")),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionDetails__WEBPACK_IMPORTED_MODULE_3__["default"], { sx: panelBodyStyle, className: 'lm-Widget' },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(_colorpanel__WEBPACK_IMPORTED_MODULE_6__["default"], { clientId: "", controlViewState: this.state.controlViewState, mainViewState: this.state.mainViewState, onRangeChange: this.onRangeChange, resetRange: this.resetRange, onColorSchemaChange: this.onColorSchemaChange, onSelectedColorChange: this.onSelectedColorChange }))),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], { expanded: this.state.filterPanel },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material_AccordionSummary__WEBPACK_IMPORTED_MODULE_4__["default"], { expandIcon: react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_ExpandMore__WEBPACK_IMPORTED_MODULE_1__["default"], null), "aria-controls": "filterPanela-content", id: "filterPanela-header", sx: panelTitleStyle, onClick: () => this.togglePanel('filterPanel') },
...
"use strict";
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"18px\" viewBox=\"0 0 24 24\" width=\"18px\" fill=\"#BBBBBB\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M5 15H3v4c0 1.1.9 2 2 2h4v-2H5v-4zM5 5h4V3H5c-1.1 0-2 .9-2 2v4h2V5zm7 3c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm7-11h-4v2h4v4h2V5c0-1.1-.9-2-2-2zm0 16h-4v2h4c1.1 0 2-.9 2-2v-4h-2v4z\"/></svg>";
...
"use strict";
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"18px\" viewBox=\"0 0 24 24\" width=\"18px\" fill=\"#BBBBBB\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M7.11 8.53L5.7 7.11C4.8 8.27 4.24 9.61 4.07 11h2.02c.14-.87.49-1.72 1.02-2.47zM6.09 13H4.07c.17 1.39.72 2.73 1.62 3.89l1.41-1.42c-.52-.75-.87-1.59-1.01-2.47zm1.01 5.32c1.16.9 2.51 1.44 3.9 1.61V17.9c-.87-.15-1.71-.49-2.46-1.03L7.1 18.32zM13 4.07V1L8.45 5.55 13 10V6.09c2.84.48 5 2.94 5 5.91s-2.16 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93s-3.05-7.44-7-7.93z\"/></svg>";
...
"use strict";
module.exports = "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"18px\" viewBox=\"0 0 24 24\" width=\"18px\" fill=\"#BBBBBB\"><path d=\"M0 0h24v24H0V0z\" fill=\"none\"/><path d=\"M15.55 5.55L11 1v3.07C7.06 4.56 4 7.92 4 12s3.05 7.44 7 7.93v-2.02c-2.84-.48-5-2.94-5-5.91s2.16-5.43 5-5.91V10l4.55-4.45zM19.93 11c-.17-1.39-.72-2.73-1.62-3.89l-1.42 1.42c.54.75.88 1.6 1.02 2.47h2.02zM13 17.9v2.02c1.39-.17 2.74-.71 3.9-1.61l-1.44-1.44c-.75.54-1.59.89-2.46 1.03zm3.89-2.42l1.42 1.41c.9-1.16 1.45-2.5 1.62-3.89h-2.02c-.14.87-.48 1.72-1.02 2.48z\"/></svg>";
...
//# sourceMappingURL=lib_index_js-lib_itkConfig_js-webpack_sharing_consume_default_emotion_react_emotion_react-web-512d65.ccc2f13bc811784c29f1.js.map